...
export function* getList({payload: {token, role_id}}){
    try {
        const response = yield fetch('http://192.168.0.105/api/list',{
            method: 'post',
            headers: {
...
export function* getIndividual({payload: {token, id}}){
    try {
        const response = yield fetch('http://192.168.0.105/api/individual',{
            method: 'post',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export function* updateIndividual({payload: {token, data}}){
    try {
        ...
        const response = yield fetch('http://192.168.0.105/api/update_individual',{
            method: 'post',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
export function* deleteIndividual({payload: {token, id}}){
    try {
        const response = yield fetch('http://192.168.0.105/api/delete_individual',{
            method: 'post',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
